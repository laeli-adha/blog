...
@InputType()
class TransactionsCreateNestedManyWithoutCategoriesInput {
...
export { TransactionsCreateNestedManyWithoutCategoriesInput as TransactionsCreateNestedManyWithoutCategoriesInput };
