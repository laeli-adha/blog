...
@InputType()
class TransactionsCreateNestedManyWithoutUsersInput {
...
export { TransactionsCreateNestedManyWithoutUsersInput as TransactionsCreateNestedManyWithoutUsersInput };
