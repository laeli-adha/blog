...
@InputType()
class TransactionsCreateNestedManyWithoutWalletsInput {
...
export { TransactionsCreateNestedManyWithoutWalletsInput as TransactionsCreateNestedManyWithoutWalletsInput };
